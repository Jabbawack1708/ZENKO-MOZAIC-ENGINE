...
def patch_number(key: str, value: str):
    global txt
    # Match: 'key': 0.12 OR "key": 0.12
...
# 2) FACEBOOST_V0 (ellipse large + center fort)
...
# 3) FACEBOOST_V0_ANTIWHITE (edge blend plus fort + feather)
